...
# Compara certificats digitals vàlids i invàlids per diferents motius. <!-- omit in toc -->
...
- [Genera un certificat digital caducat mitjançant faketime + openssl](#genera-un-certificat-digital-caducat-mitjançant-faketime--openssl)
